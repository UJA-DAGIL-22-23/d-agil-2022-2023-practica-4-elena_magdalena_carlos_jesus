...
https://github.com/UJA-DAGIL-22-23/d-agil-2022-2023-practica-4-elena_magdalena_carlos_jesus/blob/develop/assets/img/Tablero_trello_Iteracion_1_Final.png
...
Ahora vamos a hablar sobre las modificaciones que hemos hecho dentro de plantilla para poder unirlo al resto de proyectos
y trabajos de nuestros compañeros de equipo. Para ellos tuvimos que modificar una serie de clases y carpetas para que todas
ellas no tuviesen el mismo nombre, y son:

```
 -  ms-plantilla -----> carpeta
...
Debemos cambiar la carpeta para que los nombres de cada una de las carpetas ms no se fueran pisando; por lo tanto, cada proyecto 
pondrá el nombre que es su deporte. Luego de eso, dentro de la clase ms-plantilla.js y ms-plantilla-spec-js.

En ms-plantilla/server.js hemos indicado cual es el nuevo puerto en el que va a trabajar. En proxy-ruter he añadido la ruta de mi trabajo para que se pueda conectar 
con la clase de front-end, y hemos añadido el siguiente segmente dentro de (const ROUTES):
