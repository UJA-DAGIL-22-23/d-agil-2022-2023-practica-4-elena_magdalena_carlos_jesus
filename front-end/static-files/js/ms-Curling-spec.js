...
const TITULO_HOME = "Curling Home"
const TITULO_ACERCA_DE = "Curling Acerca de"
...
describe("PlantillaCurling.mostrarHome: ", function () {
    ...
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoContenido.innerHTML).toBe(PlantillaCurling.datosDescargadosNulos.mensaje)
        })
    ...
    it("muestra correctamente el título y el mensaje",
        function () {
            PlantillaCurling.mostrarHome(datosDescargadosPrueba)
            expect(elementoTitulo.innerHTML).toBe(TITULO_HOME)
...
describe("PlantillaCurling.mostrarAcercaDe: ", function () {
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoContenido.innerHTML.search(PlantillaCurling.datosDescargadosNulos.mensaje) >= 0).toBeTrue()
        })
    ...
    it("muestra correctamente el título y el mensaje conteniendo el autor, el email y la fecha",
        function () {
            PlantillaCurling.mostrarAcercaDe(datosDescargadosPrueba)
            expect(elementoTitulo.innerHTML).toBe(TITULO_ACERCA_DE)
